...
public class MainPage extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jPanel3.setBackground(new java.awt.Color(91, 206, 98));

        newlyAdded.setBackground(new java.awt.Color(20, 37, 35));
        newlyAdded.setFont(new java.awt.Font("Roboto", 0, 20)); // NOI18N
        newlyAdded.setForeground(new java.awt.Color(255, 255, 255));
        newlyAdded.setText("All Products");
        ...
        electronicsButton.setBackground(new java.awt.Color(37, 46, 45));
        ...
        cartButton.setBackground(new java.awt.Color(21, 33, 32));
        ...
        mobilesButton.setBackground(new java.awt.Color(14, 30, 29));
        ...
        kidsButton.setBackground(new java.awt.Color(27, 57, 55));
        ...
        homeTable.setBackground(new java.awt.Color(235, 183, 183));
    ...
    private void newlyAddedActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_newlyAddedActionPerformed
        ...
        try {
            list = ElectronicsDB.homePageContent();
    ...
    private void electronicsButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_electronicsButtonActionPerformed
        ...
        ArrayList<ProductList> list = null;
        try {
            list = ElectronicsDB.TableGenerator();
        } catch (ClassNotFoundException ex) {
            Logger.getLogger(MainPage.class.getName()).log(Level.SEVERE, null, ex);
        }
        Object rowData[] = new Object[6];
    ...
    private void LogInButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_LogInButtonActionPerformed
        ...
        if(signInUsernameField.getText().equals("admin") && signInPasswordField.getText().equals("admin")){
            ...
            boolean flag = false;
            try {
                flag = DbConnector.signer(signInUsernameField.getText(), signInPasswordField.getText());
            } catch (ClassNotFoundException ex) {
                Logger.getLogger(MainPage.class.getName()).log(Level.SEVERE, null, ex);
            }
    ...
    private void buyButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_buyButtonActionPerformed
        ...
        warningLabel.setText("Please Sign In first.");
            ...
            JFrame da = null;
            try {
                da = new DeliveryAddress(logger, Integer.parseInt(billLabel.getText()), date.toString());
            } catch (ClassNotFoundException ex) {
                Logger.getLogger(MainPage.class.getName()).log(Level.SEVERE, null, ex);
            }
            da.setVisible(true);
